...
<meta charset="UTF-8" />
<meta name="description" content="<?php echo $page_title . " | " . $full_gen_name; ?>, <?php echo $domain; ?>"/>
<meta name="robots" content="noodp"/>
<meta name="viewport" content="width=device-width, initial-scale=1.0, user-scalable=no, minimum-scale=1.0, maximum-scale=1.0">
<meta name="apple-mobile-web-app-capable" content="yes">
<title><?php echo $page_title . " | " . $full_gen_name; ?></title>

<meta name="keywords" content="<?php echo $domain; ?>, <?php echo $full_gen_name; ?>, <?php echo $page_title; ?>"/>
<meta property="og:url" content="<?php echo $actual_link; ?>" /> 
<meta property="og:type" content="website" />
<meta property="og:title" content="<?php echo $page_title . " | " . $full_gen_name; ?>" /> 
<meta property="og:description" content="<?php echo $page_title . " | " . $full_gen_name; ?>, <?php echo $domain; ?>" /> 
...
<ul class="main-list">
<li><a href="about/" class="<?php echo current_page("about"); ?>"><i class="fa fa-university" aria-hidden="true"></i> About Us</a></li>
<li><a href="sports/" class="<?php echo current_page("sports"); ?>"><i class="fa fa-trophy" aria-hidden="true"></i> Sports</a></li>
<li><a href="prizes/" class="<?php echo current_page("prizes"); ?>"><i class="fa fa-money" aria-hidden="true"></i> Prizes</a><li>
<li><a href="entry-rules/" class="<?php echo current_page("entry-rules"); ?>"><i class="fa fa-file-text" aria-hidden="true"></i> Entry Rules</a><li>
<li><a href="contact/" class="<?php echo current_page("contact"); ?>"><i class="fa fa-phone" aria-hidden="true"></i> Contact</a></li>
</ul>
</div>
</div>